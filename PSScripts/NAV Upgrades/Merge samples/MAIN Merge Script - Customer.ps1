#parameters
$CurrentDirectory          = 'P:\_Workingfolder\Upgrade_EEG'
$OriginalFile              = Get-ChildItem 'P:\_Workingfolder\Upgrade_EEG\Cmfrt2015_Rel05_AllObjects.txt'
$ModifiedFile              = Get-ChildItem 'P:\_Workingfolder\Upgrade_EEG\Cmfrt2015_Live_AllObjects.txt'
$TargetFile                = Get-ChildItem 'P:\_Workingfolder\Upgrade_EEG\Heyer_Live_AllObjects.txt'
$ResultFile                = Join-Path $CurrentDirectory 'Cmfrt2015_Merge_Result.txt'
...
$MergeServerInstance       = 'Cmfrt2015_App'
...
$ImportMergeResultIntoMergeDb = $false
$ImportFilesSeparately        = $false
